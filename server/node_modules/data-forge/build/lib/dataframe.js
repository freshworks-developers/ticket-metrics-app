...
var DataFrame = /** @class */ (function () {
    ...
    */
    ...
    DataFrame.prototype.melt = function (idColumnOrColumns, valueColumnOrColumns) {
        ...
        if (utils_1.isString(idColumnOrColumns)) {
            idColumnNames = [idColumnOrColumns];
        }
        else {
            if (!utils_1.isArray(idColumnOrColumns))
        ...
        if (utils_1.isString(valueColumnOrColumns)) {
            valueColumnNames = [valueColumnOrColumns];
        }
        else {
            if (!utils_1.isArray(valueColumnOrColumns))
        ...
        try {
            for (var idColumnNames_2 = __values(idColumnNames), idColumnNames_2_1 = idColumnNames_2.next(); !idColumnNames_2_1.done; idColumnNames_2_1 = idColumnNames_2.next()) {
                ...
                var columnData_1 = new tile_iterable_1.TileIterable(idData, K);
                var columnSeries_1 = new series_1.Series(columnData_1);
        ...
        var columnData = new ravel_iterable_1.RavelIterable(seriesArray);
        var columnSeries = new series_1.Series(columnData);
        mdata = mdata.withSeries('value', columnSeries);
        var valueColumnData = new repeat_iterable_1.RepeatIterable(valueColumnNames, N);
        var valueColumnSeries = new series_1.Series(valueColumnData);
    ...
    DataFrame.prototype.toJSON5 = function () {
        return json5_1.default.stringify(this.toArray(), null, 4);
    };
    /**
